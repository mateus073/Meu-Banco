...
4. Abra um Pull Request explicando o problema resolvido ou a funcionalidade implementada. Se houver modificações visuais, adicione uma captura de tela e aguarde a revisão!
